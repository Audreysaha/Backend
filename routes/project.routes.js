...
const { load, save, loadAllProjectByUser, update, removeProject, duplicateProject, updateProjectName, addPageToProject, renamePage, deletePage, deployDesign } = require("../controllers/project.comtroller");
...
router.post("/deploy", deployDesign);
